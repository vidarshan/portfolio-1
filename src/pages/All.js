    ...
    <>
      ...
      <div className="App">
        ...
        <header className='header'>
          <Scrollspy
            className="scrollspy" items={['home', 'profile', 'work', 'projects', 'achievements', 'contact']}
            ...
            <li>
              ...
              >
                <a href='#work'>
                  <svg className='nav-icon' id="Capa_1" enable-background="new 0 0 512 512" height="60" viewBox="0 0 512 512" width="60" height='60' xmlns="http://www.w3.org/2000/svg"><g><path d="m482 25h-452c-16.54 0-30 13.46-30 30v298c0 16.54 13.46 30 30 30h452c16.54 0 30-13.46 30-30v-298c0-16.54-13.46-30-30-30z" /><path d="m416 457h-81v-44h-158v44h-81c-8.28 0-15 6.72-15 15s6.72 15 15 15h320c8.28 0 15-6.72 15-15s-6.72-15-15-15z" /></g></svg>
            ...
            <li>
              ...
              >
                <a href='#contact'>
                  <svg height='60' width='60' className='nav-icon' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
